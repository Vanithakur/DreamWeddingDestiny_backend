...
@section('header')
    ...
    @include('buisness::includes.header')
@endsection
@section('content')
    <!-- slider section -->
                            ...
                            <div class="col-lg-10 col-md-11 mx-auto">
                                <div class="detail-box">
                                    ...
                                    <p>
                                        ...
                                        tempora praesentium commodi error, hic recusandae repudiandae neque ad molestias,
                                        atque veritatis labore quae eveniet autem in
                                    </p>
                                    <div class="btn-box">
                                        <a href="" class="btn1">
                                            Contact Us
        ...
        <div class="container">
            <div class="heading_container heading_center ">
                ...
                <p class="col-lg-8 px-0">
                    If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything believable.
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 offset-md-1">
                    <div class="detail-box pr-md-2">
                        ...
                        <p class="detail_p_mt">
                            ...
                            alteration in some form, by injected humour, orThere are many variations of passages of Lorem
                            Ipsum available, but the majority have suffered alteration in some form, by injected humour,
                            orThere are many variations of passages of Lorem Ipsum available, but the majority have suffered
                ...
                <div class="col-md-6 px-0">
                    <div class="img-box ">
                        <img src="{{ asset('modules/business/images/about-img.jpg') }}" class="box_img" alt="about img">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="contact_section ">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6 px-0">
                    <div class="img-box ">
                        <img src="{{ asset('modules/business/images/contact-img.jpg') }}" class="box_img" alt="about img">
                    </div>
                </div>
...
@section('footer-info-section')
    @include('buisness::includes.footer-info-section')
@endsection
@section('footer')
    @include('buisness::includes.footer')
@endsection
